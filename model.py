...
class HiRiseModel(nn.Module):
    def __init__(self):
        ...
        self.fully_con_linear_layer1 = nn.Linear(5760, 5760)
        self.fully_con_linear_layer2 = nn.Linear(5760, 5760)
        self.fully_con_linear_layer3 = nn.Linear(5760, 5760)
        self.fully_con_linear_layer4 = nn.Linear(5760, number_of_classes)

    def forward(self, x):
        x = self.convolution1(x)
        x = F.max_pool2d(x, 3)  # pooling layer
        x = F.relu(x)
